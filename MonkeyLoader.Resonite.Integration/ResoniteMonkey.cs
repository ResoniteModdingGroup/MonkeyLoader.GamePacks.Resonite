...
namespace MonkeyLoader.Resonite
{
    ...
    /// </summary>
    public interface IResoniteMonkey : IMonkey, ISubgroupedDataFeedItem
    {
        /// <summary>
        ...
        where TMonkey : ResoniteMonkey<TMonkey>, new()
    {
        ...
        /// <summary>
        /// Gets the path that the subgroup of this monkey's items in the <see cref="SettingsDataFeed"/> should have.<br/>
        /// Multiple segments are generated as nested subgroups.
        /// </summary>
        /// <remarks><para>
        /// Should be a constant value.<br/>
        /// <i>By default:</i> <c>[]</c>
        /// </para><para>
        /// <see cref="LocaleString"/> keys for the subgroups are generated by appending the
        /// subgroup's path up to that point to the parent <c><see cref="Mod">Mod</see></c>'s
        /// <see cref="IIdentifiable.FullId">FullId</see>, followed by <c>Name</c>
        /// or <c>Description</c>, all joined by periods (<c>.</c>).<br/>
        /// <i>For example:</i> <c>Mod.Id.Subgroup.NestedSubgroup.Name</c>
        /// </para></remarks>
        public virtual Sequence<string> SubgroupPath => Array.Empty<string>();
