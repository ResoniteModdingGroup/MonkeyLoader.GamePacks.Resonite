...
namespace MonkeyLoader.Resonite.UI
{
    ...
    /// As such, they will be destroyed when the local user leaves, and won't be saved either (marking it non-persistant).
    /// </summary>
    public static class LocalActionButtonExtensions
    {
        ...
        /// As such, it will be destroyed when the local user leaves, and won't be saved either (marking it non-persistant).
        /// </summary>
